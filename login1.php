            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" action="login_validasi.php" method="post">
                    <div class="form-group" action="login_validasi.php" method="post">
                    ...
                    <a href="login_validasi.php" class="btn btn-primary btn-user btn-block">
                      Login
                    </a>
                    <hr>
